    ...
    public class SliderInspector : StatefulInteractableEditor
    {
        ...
        private void OnSceneGUI()
        {
            ...
            if (slider != null)
            {
                ...
                var fmh_68_21_638214233996395379 = Quaternion.identity; Vector3 newStartPosition = Handles.FreeMoveHandle(startPos,
                    handleSize,
                    Vector3.zero,
                    Handles.SphereHandleCap);
                var fmh_73_21_638214233996398530 = Quaternion.identity; Vector3 newEndPosition = Handles.FreeMoveHandle(endPos,
                    handleSize,
                    Vector3.zero,
                    Handles.SphereHandleCap);
